...
const Contact = () => {
  ...
  <div className="absolute inset-0 overflow-hidden opacity-35 pointer-events-none">
      ...
      {/* Code Editor Window - Contact themed (background, not overlapping headings) */}
      <motion.div
      ...
      >
        {/* <div className="space-y-1">
          <div><span className="text-[#F778BA]">const</span> <span className="text-[#58A6FF]">Contact</span> = &#123;</div>
          <div className="ml-2"><span className="text-[#F778BA]">Email</span> <span className="text-green-400">['kiranm1102@gmail.com']</span>,</div>
          <div className="ml-2"><span className="text-[#F778BA]">Mobile:</span> <span className="text-green-400">['9739896965']</span>,</div>
          <div className="ml-2"><span className="text-[#F778BA]">Location:</span> <span className="text-green-400">['Bengaluru, India']</span></div>
          <div>&#125;;</div>
        </div> */}
      </motion.div>
